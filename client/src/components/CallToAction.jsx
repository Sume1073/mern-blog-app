  ...
  return (
    <div className='flex flex-col sm:flex-row p-3 border border-teal-500 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center'>
      <div className="flex-1 justify-center flex flex-col">
        ...
        {/* The <a> tag inside Button to make the entire button clickable */}
        <Button
          gradientDuoTone='purpleToPink'
          className='rounded-tl-xl rounded-bl-none w-full' 
        >
          <a
            href="https://www.linkedin.com/in/sumedha-chakrabarty-964810202/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white w-full h-full flex items-center justify-center"  // Ensure the link takes up the full space of the button
          >
            Connect on LinkedIn
          </a>
        </Button>
